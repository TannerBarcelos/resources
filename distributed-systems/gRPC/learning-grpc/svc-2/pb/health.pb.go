...
type HealthResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Status        string                 `protobuf:"bytes,1,opt,name=status,proto3" json:"status,omitempty"`   // e.g. "UP" or "DOWN"
	Version       string                 `protobuf:"bytes,2,opt,name=version,proto3" json:"version,omitempty"` // optional version info
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_health_proto_rawDesc = "" +
	...
	"\rHealthService\x12:\n" +
	"\tGetHealth\x12\x15.health.HealthRequest\x1a\x16.health.HealthResponseB\x04Z\x02./b\x06proto3"
...
var file_health_proto_depIdxs = []int32{
	0, // 0: health.HealthService.GetHealth:input_type -> health.HealthRequest
	1, // 1: health.HealthService.GetHealth:output_type -> health.HealthResponse
